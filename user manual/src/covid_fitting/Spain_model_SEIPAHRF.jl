...
S0=N-11; E0=0; I0=10; P0=1; A0=0; H0=0; R0=0; F0=0
...
## plotting
DateTick=Date(2020,2,25):Day(1):Date(2020,6,7)
...
plot(DateTick2,X1, ylabel="Daily new confirmed cases",lw=3,
     label="M1",xrotation=rad2deg(pi/3), linestyle=:dashdot)
    plot!(Xf1, label="Mf1", lw=3)
    plot!(Xf8,  label="Mf8", linestyle=:dash, lw=3)
    scatter!(C, label= "Real data",legendposition=(.88,.6),legendfontsize=7,
	title = "(a) Spain" , titleloc = :left, titlefont = font(10))
	plSpain=bar!(["M1" "Mf1" "Mf8"],[Err1 Errf1 Errf8], ylabel="RMSD",
