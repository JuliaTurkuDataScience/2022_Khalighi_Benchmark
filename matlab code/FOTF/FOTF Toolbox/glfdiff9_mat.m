function dy=glfdiff9_mat(y,t,gam,p)
% glfdiff9 - evaluation of O(h^p) GL derivatives, matrix version 
%
%   dy=glfdiff9_mat(y,t,gam,p)
%
...
% Last modified 18 May, 2022 
   ...
   dv=rot90(hankel(w(end:-1:1)))*v/h^gam;
